...
public interface AppUserDao {
    ...
    ParameterMap selectByPrimaryKey(Long userId);
    ...
    List<ParameterMap> getAppUserByConditionList(ParameterMap pm);
    
    long getByConditionCount(ParameterMap pm);

    ParameterMap getDeteilByUserId(ParameterMap pm);
}