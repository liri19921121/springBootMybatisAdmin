...
package com.admin.dao.dailyTotalDetail;
...
@Repository
public interface DailyTotalDetailDao {
	
    int deleteByPrimaryKey(Long dailyTotalDetailId);

    int insert(ParameterMap pm);

    int insertSelective(ParameterMap pm);

    ParameterMap selectByPrimaryKey(Long dailyTotalDetailId);
