...
import com.admin.datasource.DatabaseType;
...
public class MyBatisConfig implements EnvironmentAware {
    ...
    public DataSource firstDataSource() throws Exception {
        ...
        props.put("driverClassName", env.getProperty("first.datasource.driverClassName"));
    ...
    public DataSource secondDataSource() throws Exception {
    	Properties props = new Properties();
        props.put("driverClassName", env.getProperty("second.datasource.driverClassName"));
