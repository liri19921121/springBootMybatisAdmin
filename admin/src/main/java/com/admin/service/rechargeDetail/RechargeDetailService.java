...
package com.admin.service.rechargeDetail;
...
public interface RechargeDetailService {
        ...
        /**
         * 根据主键删除
         * @param rechargeDetailId
         * @return
         */
     	public int deleteByPrimaryKey(java.lang.Long rechargeDetailId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(java.lang.Long rechargeDetailId) throws Exception;
	    ...
	    * @param record
	    ...
	    public List<ParameterMap> getRechargeList(ParameterMap pm)throws Exception;
	    /**
	     * 根据条件查询集合数量
	     * @param argmap
	     * @return
