...
package com.admin.service.coinInfo;
...
public interface CoinInfoService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(Long coinInfoId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(Long coinInfoId) throws Exception;
