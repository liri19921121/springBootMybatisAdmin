...
package com.admin.service.dealAppeal;
...
public interface DealAppealService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(Long dealAppealId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(ParameterMap pm) throws Exception;
