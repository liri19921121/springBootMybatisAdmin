...
package com.admin.service.dailyTotal;
...
public interface DailyTotalService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(java.lang.Long dailyTotalId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(java.lang.Long dailyTotalId) throws Exception;
