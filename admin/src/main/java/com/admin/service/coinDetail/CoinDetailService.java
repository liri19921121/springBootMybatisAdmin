...
package com.admin.service.coinDetail;
...
public interface CoinDetailService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(Long coinDetailId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(Long coinDetailId) throws Exception;
