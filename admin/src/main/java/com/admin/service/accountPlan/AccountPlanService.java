...
package com.admin.service.accountPlan;
...
public interface AccountPlanService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(Long accountPlanId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(Long accountPlanId) throws Exception;
