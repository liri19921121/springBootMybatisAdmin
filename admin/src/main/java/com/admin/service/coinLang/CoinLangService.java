...
package com.admin.service.coinLang;
...
public interface CoinLangService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(Long coinLangId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(Long coinLangId) throws Exception;
