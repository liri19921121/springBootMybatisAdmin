...
package com.admin.service.userExtendInfo;
...
public interface UserExtendInfoService {
        ...
        /**
         * 根据主键删除
         * @param userExtendInfoId
         * @return
         */
     	public int deleteByPrimaryKey(Long userExtendInfoId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(Long userExtendInfoId) throws Exception;
