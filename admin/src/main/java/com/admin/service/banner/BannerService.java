...
package com.admin.service.banner;
...
public interface BannerService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(Long bannerId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(Long bannerId) throws Exception;
