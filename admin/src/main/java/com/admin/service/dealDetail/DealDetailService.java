...
package com.admin.service.dealDetail;
...
public interface DealDetailService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(Long dealDetailId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(Long dealDetailId) throws Exception;
