...
package com.admin.service.lockMoneyDetail;
...
public interface LockMoneyDetailService {
	
        /**
         * 根据主键删除
         * @param lockMoneyDetailId
         * @return
         */
     	public int deleteByPrimaryKey(java.lang.Long lockMoneyDetailId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(java.lang.Long lockMoneyDetailId) throws Exception;
