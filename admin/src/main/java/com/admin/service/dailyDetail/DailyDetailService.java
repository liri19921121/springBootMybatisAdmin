...
package com.admin.service.dailyDetail;
...
public interface DailyDetailService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(java.lang.Long dailyDetailId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(java.lang.Long dailyDetailId) throws Exception;
