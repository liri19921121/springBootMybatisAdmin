...
package com.admin.service.freeMoneyDetail;
...
public interface FreeMoneyDetailService {
	
        /**
         * 根据主键删除
         * @param freeMoneyDetailId
         * @return
         */
     	public int deleteByPrimaryKey(java.lang.Long freeMoneyDetailId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(java.lang.Long freeMoneyDetailId) throws Exception;
