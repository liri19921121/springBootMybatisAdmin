...
package com.admin.service.goodsType;
...
public interface GoodsTypeService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(Long goodsTypeId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(Long goodsTypeId) throws Exception;
