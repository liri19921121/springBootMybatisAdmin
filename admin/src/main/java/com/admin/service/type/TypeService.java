...
package com.admin.service.type;
...
public interface TypeService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(Long typeId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(Long typeId) throws Exception;
