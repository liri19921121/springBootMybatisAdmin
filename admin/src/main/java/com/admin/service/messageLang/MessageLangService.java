...
package com.admin.service.messageLang;
...
public interface MessageLangService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(Long messageLangId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(Long messageLangId) throws Exception;
