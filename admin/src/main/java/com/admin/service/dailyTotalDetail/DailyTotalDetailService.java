...
package com.admin.service.dailyTotalDetail;
...
public interface DailyTotalDetailService {
	
        /**
         * 根据主键删除
         * @param dailyTotalDetailId
         * @return
         */
     	public int deleteByPrimaryKey(java.lang.Long dailyTotalDetailId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(java.lang.Long dailyTotalDetailId) throws Exception;
