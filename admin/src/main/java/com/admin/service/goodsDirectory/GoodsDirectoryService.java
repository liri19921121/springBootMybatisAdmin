...
package com.admin.service.goodsDirectory;
...
public interface GoodsDirectoryService {
	
        /**
         * 根据主键删除
         * @param goodsDirectoryId
         * @return
         */
     	public int deleteByPrimaryKey(Long goodsDirectoryId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(Long goodsDirectoryId) throws Exception;
