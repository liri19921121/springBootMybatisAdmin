...
package com.admin.service.workOrder;
...
public interface WorkOrderService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(Long workOrderId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(Long workOrderId) throws Exception;
	    ...
	    * @param record
	    ...
	    public List<WorkOrderDTO> selectWorkOrderList(Long id) throws  Exception;
