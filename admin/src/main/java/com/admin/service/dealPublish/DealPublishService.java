...
package com.admin.service.dealPublish;
...
public interface DealPublishService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(Long dealPublishId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(Long dealPublishId) throws Exception;
