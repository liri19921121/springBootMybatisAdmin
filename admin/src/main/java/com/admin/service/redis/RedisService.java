package com.admin.service.redis;
...
public interface RedisService {
	 ...
	 * @param timeout
	 */
	void setExpireTime(String key,Long timeout);
	 ...
	 * @return 执行 HINCRBY 命令之后，哈希表 hKey 中域 hashKey 的值。
	 */
	Double hashIncrementDoubleOfHashMap(String hKey, String hashKey,
			Double delta);
	...
	/**
	 *  如果 key 已经存在并且是一个字符串， APPEND 命令将 value 追加到 key 原来的值的末尾。 如果 key 不存在，
	 ...
	 * @return 
	 */
	Object stringGetByKey(String key);
	 ...
	 *       
	 */
	void stringSetObject(String key, Object value);
