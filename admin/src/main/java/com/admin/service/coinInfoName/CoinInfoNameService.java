...
package com.admin.service.coinInfoName;
...
public interface CoinInfoNameService {
	
        /**
         * 根据主键删除
         * @param coinInfoNameId
         * @return
         */
     	public int deleteByPrimaryKey(Long coinInfoNameId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(Long coinInfoNameId) throws Exception;
