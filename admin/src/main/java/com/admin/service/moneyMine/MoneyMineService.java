...
package com.admin.service.moneyMine;
...
public interface MoneyMineService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(java.lang.Long moneyMineId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(java.lang.Long moneyMineId) throws Exception;
