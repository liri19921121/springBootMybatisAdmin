...
package com.admin.service.redelivery;
...
public interface RedeliveryService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(java.lang.Long redeliveryId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(java.lang.Long redeliveryId) throws Exception;
