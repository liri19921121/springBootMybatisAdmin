...
package com.admin.service.coinPublish;
...
public interface CoinPublishService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(Long coinPublishId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(Long coinPublishId) throws Exception;
