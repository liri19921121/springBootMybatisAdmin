...
package com.admin.service.tranHedging;
...
public interface TranHedgingService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(java.lang.Long tranHedgingId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(java.lang.Long tranHedgingId) throws Exception;
	    ...
	    * @param record
	    ...
	    public List<ParameterMap> getTranHedgingList(ParameterMap pm)throws Exception;
	    /**
	     * 根据条件查询集合数量
	     * @param argmap
	     * @return
