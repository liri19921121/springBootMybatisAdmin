...
package com.admin.service.message;
...
public interface MessageService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(Long messageId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(Long messageId) throws Exception;
