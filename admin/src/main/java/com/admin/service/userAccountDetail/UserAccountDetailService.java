...
package com.admin.service.userAccountDetail;
...
public interface UserAccountDetailService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(java.lang.Long userAccountDetailId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(java.lang.Long userAccountDetailId) throws Exception;
