...
public interface NewsContentService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(java.lang.Long newsContentId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(java.lang.Long newsContentId) throws Exception;
