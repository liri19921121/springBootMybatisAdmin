...
package com.admin.service.workOrderDetail;
...
public interface WorkOrderDetailService {
         ...
         * @return
         */
     	public int deleteByPrimaryKey(Long workOrderDetailId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(Long workOrderDetailId) throws Exception;
