...
package com.admin.service.userExtendLang;
...
public interface UserExtendLangService {
	
        /**
         * 根据主键删除
         * @param userExtendLangId
         * @return
         */
     	public int deleteByPrimaryKey(Long userExtendLangId) throws Exception;
         ...
         * @return
         */
     	public ParameterMap selectByPrimaryKey(Long userExtendLangId) throws Exception;
