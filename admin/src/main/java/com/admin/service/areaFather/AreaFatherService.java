...
package com.admin.service.areaFather;
...
public interface AreaFatherService {
     ...
     * @return
     */
    public int deleteByPrimaryKey(Long areaFatherId) throws Exception;
     ...
     * @return
     */
    public ParameterMap selectByPrimaryKey(Long areaFatherId) throws Exception;
