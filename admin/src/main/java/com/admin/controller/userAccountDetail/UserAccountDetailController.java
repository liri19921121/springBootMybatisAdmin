...
package com.admin.controller.userAccountDetail;
...
public class UserAccountDetailController extends BaseController{
	...
	private final static String qxurl="userAccountDetail/list";
	...
	public Object list(@PathVariable(value="page",required=false)Integer pageNo,Model model){
		try {
			...
			Page<ParameterMap> page = PageHelper.startPage(pageNo, Const.PAGE_SIZE).doSelectPage(() -> {
				try {
					userAccountDetailService.getByConditionList(pm);
				} catch (Exception e) {
					e.printStackTrace();
				}
			});
			model.addAttribute("userAccountDetail", page.getResult());
		...
		return "page/userAccountDetail/list";
	}
	...
	public Object getDetail() throws Exception{
		return userAccountDetailService.getDetail(this.getParameterMap());
	}
	...
	public Object edit() throws Exception{
		return userAccountDetailService.edit(this.getParameterMap(),this.getSession());
	}
	...
	public Object add() throws Exception{
		return userAccountDetailService.add(this.getParameterMap(),this.getSession());
	}
	...
	public Object del() throws Exception{
		return userAccountDetailService.del(this.getParameterMap());
	}
}