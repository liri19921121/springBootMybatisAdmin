...
public class DailyDetailController extends BaseController{
	...
	private final static String qxurl="dailyDetail/list";
	...
	public Object list(@PathVariable(value="page",required=false)Integer pageNo,Model model){
		try {
			...
			Page<ParameterMap> page = PageHelper.startPage(pageNo, Const.PAGE_SIZE).doSelectPage(() -> {
				try {
					dailyDetailService.getByConditionList(pm);
				} catch (Exception e) {
					e.printStackTrace();
				}
			});
			model.addAttribute("dailyDetail", page.getResult());
	...
	public Object getDetail() throws Exception{
		return dailyDetailService.getDetail(this.getParameterMap());
	}
	...
	public Object edit() throws Exception{
		return dailyDetailService.edit(this.getParameterMap(),this.getSession());
	}
	...
	public Object add() throws Exception{
		return dailyDetailService.add(this.getParameterMap(),this.getSession());
	}
	...
	public Object del() throws Exception{
		return dailyDetailService.del(this.getParameterMap());
	}
}